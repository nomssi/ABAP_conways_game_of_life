...
CLASS conway_view IMPLEMENTATION.
  ...
  METHOD _set_status.
    ...
    DATA lt_excluding TYPE STANDARD TABLE OF char20 WITH NON-UNIQUE DEFAULT KEY.
...
CLASS controller IMPLEMENTATION.
  ...
  METHOD is_timer_active.
    ...
    r_is_timer_active = xsdbool( m_timer_current < m_timer_max ).
  ...
  METHOD clean_up.
    ...
    TRY.
        ...
        CAST if_amc_message_producer_text( cl_amc_channel_manager=>create_message_producer(
                     i_application_id = 'ZAMC_WAKEUP'
                     i_channel_id     = '/channel' ) )->send( |__CLOSE__| ).
